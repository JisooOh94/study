...
public class MultiplierFactory {  
	...
	public static getMultiplier(int num) { if(num > 100000000) {       
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA1MjY3OTIyMCwtMTczMTEyMzQ3MV19
-->