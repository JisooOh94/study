...
public class ExtendedFileListResult<T> {
	...
	public static ExtendedFileListResult<T> getFileListResultObjWithNan() {
...
private ExtendedFileListResult<FileResult> getFileList(DriveUser user, ListParam listParam) {  
	...
	ExtendedFileListResult<FileResult> result = ExtendedFileListResult.
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0OTQ0ODM5MCwzNjMxMDM1MTEsLTIwOT
M0NTQ2OTQsMjA4OTkyNDIxNiwtMTczMTEyMzQ3MV19
-->