...
public class DeviceInfo {
	...
	public DeviceInfo(HttpServletRequest request) {
		String ua = request.getHeader(DeviceInfo.KEY_HEADER_USER_AGENT);
		this.userAgent = ua;
		this.appInfo = CookieUtils.getCookie(request, DeviceInfo.KEY_COOKIE_APP_INFO);
	}
...
public class NoticeBO {
     ...
     * @return 공지사항을 업데이트한다.
     */
    public void updateNoticeDataList() {
    	List<NoticeData> noticeData = noticeDAO.selectNoticeDataList(NoticeBO.NOTICE_TYPE_LOGOUT, noticeLogoutCount);
    	List<NoticeData> noticeMainData = noticeDAO.selectNoticeDataList(NoticeBO.NOTICE_TYPE_MAIN, noticeMainCount);
    	List<NoticeData> noticeUrgencyData = noticeDAO.selectNoticeDataList(NoticeBO.NOTICE_TYPE_URGENCY, noticeUrgentCount);
    	List<NoticeData> noticeAddonUseTipData = noticeDAO.selectNoticeDataList(NoticeBO.NOTICE_TYPE_ADDON_USE_TIP, noticeAddonUseTipCount);
    	noticeListData.putNoticeMap(NoticeListData.NOTICE_KEY_LOGOUT, noticeData);
    	noticeListData.putNoticeMap(NoticeListData.NOTICE_KEY_MAIN, noticeMainData);
    	noticeListData.putNoticeMap(NoticeListData.NOTICE_KEY_ADDON_URGENCY, noticeUrgencyData);
    	noticeListData.putNoticeMap(NoticeListData.NOTICE_KEY_ADDON_USE_TIP, noticeAddonUseTipData);
    }
}
```