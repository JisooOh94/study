...
|반환형|메서드명|파라미터|설명|
|:------:|:----------:|:----------:|:------|
|boolean|removeIf|Predicate< T> filter|조건식(Predicate)에 부합되는 요소 삭제|
|

<!--stackedit_data:
eyJoaXN0b3J5IjpbNDEwMDg5MjE1LDQ2ODM0OTIyOSwxNDIxMj
I0OTIxLC0xNjE5NjI1NTc0LDE1NzU0NjgwNzFdfQ==
-->