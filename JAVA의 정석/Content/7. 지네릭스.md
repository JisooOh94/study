...
public static void main(String[] args) {
   ...
   allList = new ArrayList<Strange>(); 

}
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NjUyNjEyNDEsLTExMzMyODc1NDcsLT
YxODI0MDkyMiwtMjg1NzA4MzE4LDE1MzU1MjUxMDcsMTI3ODA1
NTY0MywtMTMxMDE1NTYwMSwxMDY1MDAyMzQwXX0=
-->